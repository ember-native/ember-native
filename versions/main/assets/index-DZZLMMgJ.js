const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-DfWs-sfi.js","assets/main-CjWhnG7r.js","assets/main-CTnIdGih.css","assets/plugin-DmClH3Fo.js","assets/_commonjsHelpers-D5KtpA0t.js","assets/index-BSZFMcPe.js","assets/babel-85PMSO9b.js"])))=>i.map(i=>d[i]);
import { $ as decorateClass, a0 as decorateFieldV1, a1 as decorateFieldV2, a2 as initializeDeferredDecorator, a3 as decorateMethodV1, a4 as decorateMethodV2, a5 as decoratePOJO, _ as _tracking, L as GlimmerComponent, N as _owner, a as templateFactory, O as _service, P as _runloop, Q as _object, R as _modifier, T as _helpers, U as _destroyable, V as _debug, X as _array, Y as _application, t as templateOnly, n as nameFor, Z as __vitePreload } from './main-CjWhnG7r.js';
...
async function transform(intermediate, name) {
  ...
  __vitePreload(() => import('./index-DfWs-sfi.js'),true              ?__vite__mapDeps([0,1,2]):void 0), __vitePreload(() => import('./plugin-DmClH3Fo.js').then(n => n.p),true              ?__vite__mapDeps([3,4,5,1,2]):void 0)]);
