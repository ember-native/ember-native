import { i as it$1, X as Xe$1, I as Ie$1, t as te$1, o as ot$1, r as rt$1, a as t, b as r, c as at$1, x as x$1, P as P$1, n, j as j$1, h, A as A$1, S as S$1, e } from './index-BecZGZPp.js';
...
function q(r) {
  ...
  }(r) : "string" == typeof r ? K(J(r), false) : void A$1(r);
}
function K(e, t) {
  return e.type === L ? {
    kind: w,
...
function Q(e) {
  ...
  return function (e, t) {
    ...
    "as" === e ? n = Array.isArray(s) ? s : [s] : (r = r || h(), r[e] = ie(s));
  }), {
    hash: r,
    blockParams: n
  };
...
class me {
  constructor(e, r) {
    this.parent = e, this.locals = h();
    for (let t of r) this.locals[t] = e.top.symbol(t);
  }
  get paramSymbols() {
    return S$1(this.locals);
  }
  get top() {
...
function ke(t$1, r = new pe()) {
  switch (t$1.kind) {
    case w:
      return [[t$1.trusted ? t.TrustingAppend : t.Append, Te(t$1.path, r)]];
    case A:
      return [[t$1.trusted ? t.TrustingAppend : t.Append, Se(t$1.expr, t$1.trusted ? "TrustedAppend" : "Append", r)]];
    case g:
      {
        let {
            head: e$1,
          ...
          o = a ? Ie(a, r) : null,
          c = i ? He(i, r) : null,
          u = Oe(e$1, l ? e.ResolveAsHelperHead : e.ResolveAsComponentOrHelperHead, r);
        return [[l ? t.TrustingAppend : t.Append, [t.Call, u, o, c]]];
      }
    case b:
      return [[t.Append, t$1.value]];
    case C:
      return [[t.Comment, t$1.value]];
    case k:
      {
        let e$1 = function (e, t, r) {
            let n = [],
              s = [];
            ...
            return [n, s];
          }(t$1.blocks, t$1.blockParams, r),
          a = He(t$1.hash, r),
          i = Ie(t$1.params, r),
          l = Oe(t$1.head, e.ResolveAsComponentHead, r);
        return [[t.Block, l, i, a, e$1]];
      }
    case S:
      return [be(t$1, r)];
    case v:
      return function ({
        ...
        let a = [xe(t$1) ? [t.OpenElementWithSplat, e] : [t.OpenElement, e]];
        if (t$1) {
          let {
            params: e
          } = function (e, t$1) {
            let r = [],
              n = [],
              a = [];
            for (const [i, l] of Object.entries(e)) l === B ? r.push([t.AttrSplat, t$1.block("&attrs")]) : "@" === i[0] ? (n.push(i), a.push(Se(l, "Strict", t$1))) : r.push(...Ce(i, l, Ee(i), t$1));
            return {
              params: r,
        ...
        return a.push([t.FlushElement]), Array.isArray(r) && r.forEach(e => a.push(...ke(e, n))), a.push([t.CloseElement]), a;
      }(t$1, r);
    case x:
      throw he("modifier");
    case E:
...
function be(e, t$1) {
  let {
    ...
    n = Ie(e.params, t$1),
    a = t$1.child(e.blockParams || []),
    i = Le(e.blocks.default, a, a.paramSymbols),
    l = e.blocks.else ? Le(e.blocks.else, t$1, []) : null;
  switch (r) {
    case "let":
      return [t.Let, n, i];
    case "if":
    ...
    case "each":
      {
        let r = e.hash ? e.hash.key : null,
          a = r ? Se(r, "Strict", t$1) : null;
        return [t.Each, n[0], a, i, l];
      }
    default:
...
function Ce(e, t$1, r, n) {
  if (t$1.type === P) {
    let n = t$1.value;
    if (false === n) return [];
    if (true === n) return [[t.StaticAttr, e, "", r ?? void 0]];
    if ("string" == typeof n) return [[t.StaticAttr, e, n, r ?? void 0]];
    throw new Error(`Unexpected/unimplemented literal attribute ${JSON.stringify(n)}`);
  }
  return [[t.DynamicAttr, e, Se(t$1, "AttrValue", n), r ?? void 0]];
}
function Be(e, t) {
  switch (e) {
    case "Append":
...
function Se(t$1, r, a) {
  switch (t$1.type) {
    case L:
      return Te(t$1, a);
    case $:
      return Ne(t$1.variable, Be(r, true), a);
    case G:
      return [t.Concat, Pe(t$1.params, a)];
    case H:
      {
        let e = Ie(t$1.params, a),
          n = He(t$1.hash, a),
          i = Oe(t$1.head, "Strict" === r ? "SubExpression" : Be(r, false), a);
        return [t.Call, i, e, n];
      }
    case M:
      return [t.HasBlock, Ne({
        kind: N,
        name: t$1.name
      }, e.Strict, a)];
    case D:
      return [t.HasBlockParams, Ne({
        kind: N,
        name: t$1.name
      }, e.Strict, a)];
    case P:
      return void 0 === t$1.value ? [t.Undefined] : t$1.value;
    default:
      A$1(t$1);
  }
}
...
function Te(e$1, t) {
  return Ne(e$1.path.head, e.Strict, t, e$1.path.tail);
}
function Ne(e$1, t$1, r, a) {
  let i,
    l = t.GetSymbol;
  return e$1.kind === T ? (l = "Strict" === t$1 ? t.GetStrictKeyword : "AppendBare" === t$1 || "AppendInvoke" === t$1 ? t.GetFreeAsComponentOrHelperHead : "TrustedAppendBare" === t$1 || "TrustedAppendInvoke" === t$1 || "AttrValueBare" === t$1 || "AttrValueInvoke" === t$1 || "SubExpression" === t$1 ? t.GetFreeAsHelperHead : function (e$1) {
    switch (e$1) {
      case e.Strict:
        return t.GetStrictKeyword;
      case e.ResolveAsComponentOrHelperHead:
        return t.GetFreeAsComponentOrHelperHead;
      case e.ResolveAsHelperHead:
        return t.GetFreeAsHelperHead;
      case e.ResolveAsModifierHead:
        return t.GetFreeAsModifierHead;
      case e.ResolveAsComponentHead:
        return t.GetFreeAsComponentHead;
      default:
        return;
    }
  }(t$1), i = r.freeVar(e$1.name)) : (l = t.GetSymbol, i = function (e, t, r) {
    switch (e) {
      case "Arg":
        return t.arg(r);
      case N:
  ...
  }(e$1.kind, r, e$1.name)), void 0 === a || 0 === a.length ? [l, i] : ([l, i, a]);
}
function Ie(e, t) {
...
class wr {
  ...
  formatHash(e) {
    return null === e ? null : e[0].reduce((t, r, n) => (t[r] = this.formatOpcode(e[1][n]), t), h());
  }
  formatBlocks(e) {
    return null === e ? null : e[0].reduce((t, r, n) => (t[r] = this.formatBlock(e[1][n]), t), h());
  }
  formatBlock(e) {
    return {
