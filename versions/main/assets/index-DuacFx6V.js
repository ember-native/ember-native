...
async function transform(intermediate, name) {
  ...
  __vitePreload(() => import('./index-C06A1Wma.js'),true              ?__vite__mapDeps([0,1,2]):void 0), __vitePreload(() => import('./plugin-DvgdKuV3.js').then(n => n.p),true              ?__vite__mapDeps([3,4,5]):void 0)]);
