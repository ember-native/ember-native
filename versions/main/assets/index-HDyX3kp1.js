const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-D8DmX4qN.js","assets/main-UBeHWpUP.js","assets/main-CTnIdGih.css","assets/plugin-DSr8DBgu.js","assets/_commonjsHelpers-D5KtpA0t.js","assets/index-BecZGZPp.js","assets/babel-85PMSO9b.js"])))=>i.map(i=>d[i]);
import { T as decorateClass, U as decorateFieldV1, V as decorateFieldV2, W as initializeDeferredDecorator, X as decorateMethodV1, Y as decorateMethodV2, Z as decoratePOJO, _ as _tracking, G as GlimmerComponent, E as _owner, a as templateFactory, F as _service, I as _runloop, J as _object, K as _modifier, L as _helpers, N as _destroyable, O as _debug, P as _array, Q as _application, t as templateOnly, n as nameFor, R as __vitePreload } from './main-UBeHWpUP.js';
import { _ as _template, a as _utils, b as _EmberComponentHelper, c as _EmberComponent, d as _importSync20 } from './ember-template-compiler-B0m1oKdQ.js';
...
async function transform(intermediate, name) {
  ...
  __vitePreload(() => import('./index-D8DmX4qN.js'),true              ?__vite__mapDeps([0,1,2]):void 0), __vitePreload(() => import('./plugin-DSr8DBgu.js').then(n => n.p),true              ?__vite__mapDeps([3,4,5]):void 0)]);
