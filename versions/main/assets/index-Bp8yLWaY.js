...
function requireMakeArrayOfStrings () {
	...
	(function (exports) {
		...
		exports["default"] = void 0;
		var _makeArrayOfLength = _interopRequireDefault(requireMakeArrayOfLength());
...
function requireUtil () {
	...
	(function (exports) {
		...
		var _isNode = _interopRequireDefault(requireIsNode());
		var _isReactNative = _interopRequireDefault(requireIsReactNative());
		var _isWindows = _interopRequireDefault(requireIsWindows());
		var _makeArrayOfLength = _interopRequireDefault(requireMakeArrayOfLength());
		var _makeArrayOfStrings = _interopRequireDefault(requireMakeArrayOfStrings());
		function _interopRequireDefault(obj) {
		  return obj && obj.__esModule ? obj : {
		    "default": obj
		  };
...
function requireLoremIpsum () {
	...
	(function (exports) {
		...
		exports["default"] = void 0;
		var _formats = requireFormats();
		var _lineEndings = requireLineEndings();
		var _generator = _interopRequireDefault(requireGenerator());
		var _util = requireUtil();
		function _interopRequireDefault(obj) {
		  return obj && obj.__esModule ? obj : {
		    "default": obj
...
function requireDist () {
	...
	(function (exports) {
		...
		var _formats = requireFormats();
		var _units = requireUnits();
		var _words = requireWords();
		var _LoremIpsum = _interopRequireDefault(requireLoremIpsum());
		function _interopRequireDefault(obj) {
		  return obj && obj.__esModule ? obj : {
		    "default": obj
		  };
