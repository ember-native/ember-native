const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-D_eEFUch.js","assets/main-D4pLDrzl.js","assets/main-CTnIdGih.css","assets/plugin-DvgdKuV3.js","assets/_commonjsHelpers-D5KtpA0t.js","assets/index-Bhthv0jx.js","assets/babel-85PMSO9b.js"])))=>i.map(i=>d[i]);
import { I as Input, T as Textarea, w as componentCapabilities, x as Component, y as getComponentTemplate, z as setComponentManager, s as setComponentTemplate, B as decorateClass, E as decorateFieldV1, F as decorateFieldV2, G as initializeDeferredDecorator, J as decorateMethodV1, K as decorateMethodV2, L as decoratePOJO, N as compare, O as isBlank, P as isEmpty, Q as isEqual, R as isNone, U as isPresent, V as typeOf, W as Helper, X as helper$1, Y as htmlSafe, Z as isHTMLSafe, _ as _tracking, $ as GlimmerComponent, a0 as _owner, a as templateFactory, a1 as _service, a2 as _runloop, a3 as _object, a4 as _modifier, a5 as _helpers, a6 as _destroyable, a7 as _debug, a8 as _array, a9 as _application, t as templateOnly, n as nameFor, aa as __vitePreload } from './main-D4pLDrzl.js';
		...
		(function (ember, emberGlimmer, templateCompilation, emberApp) {
		  ...
		  */
		  ...
		  var publicBuilder = {
		    ...
		    program: function (body, blockParams, loc) {
		      return deprecate$1("b.program is deprecated. Use b.template or b.blockItself instead."), blockParams && blockParams.length ? buildBlockItself(body, blockParams, false, loc) : buildTemplate(body, [], loc);
		    },
		  ...
		  class HandlebarsNodeVisitors extends Parser {
		    ...
		    parseProgram(node, program) {
		      ...
		      if (node !== poppedNode) {
		        ...
		        debugAssert(void 0 !== poppedNode, "[BUG] empty parser elementStack"), debugAssert(false, `[BUG] mismatched parser elementStack node: ${node.type}`);
		      }
		      return node;
		    }
		    BlockStatement(block) {
		  ...
		  class TokenizerEventHandlers extends HandlebarsNodeVisitors {
		    ...
		    finishTag() {
		      ...
		      } else "EndTag" === tag.type && this.finishEndTag(false);
		    }
		    finishStartTag() {
		      let {
		        name: name,
		  ...
		  */
		  ...
		  function ComponentSyntaxContext(node) {
		    return isSimplePath(node) ? LooseModeResolution.namespaced(COMPONENT_NAMESPACE, true) : null;
		  }
		  ...
		  function normalizeStatement(statement) {
		    ...
		    if ("string" == typeof statement) return normalizeAppendHead(normalizeDottedPath(statement), false);
...
var emberTemplateCompilerExports = requireEmberTemplateCompiler();
...
async function preprocess(input, name) {
  if (!fetchingPromise) {
    fetchingPromise = __vitePreload(() => import('./standalone-Na0xQsMb.js'),true              ?[]:void 0);
  }
  if (!processor) {
    const {
      Preprocessor
...
async function transform(intermediate, name) {
  ...
  __vitePreload(() => import('./index-D_eEFUch.js'),true              ?__vite__mapDeps([0,1,2]):void 0), __vitePreload(() => import('./plugin-DvgdKuV3.js').then(n => n.p),true              ?__vite__mapDeps([3,4,5]):void 0)]);
